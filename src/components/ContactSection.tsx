  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        ...
        {/* Contact Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 mb-12 sm:mb-16 px-4 sm:px-0">
          {/* Contact Information */}
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-start space-x-3 sm:space-x-4 group">
                <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-blue-500/20 border border-blue-500/30 rounded-xl flex items-center justify-center group-hover:bg-blue-500/30 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-blue-500/20">
                ...
                <div>
                  <h4 className="font-semibold text-white text-base sm:text-lg">Email</h4>
                  <p className="text-blue-200 text-sm sm:text-base">info@innovativebimservices.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4 group">
                ...
                <div>
                  <h4 className="font-semibold text-white text-base sm:text-lg">Phone</h4>
                  <p className="text-blue-200 text-sm sm:text-base">+1 (555) 123-4567</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4 group">
                ...
                <div>
                  <h4 className="font-semibold text-white text-base sm:text-lg">Address</h4>
                  <p className="text-blue-200 text-sm sm:text-base">123 Innovation Drive, Tech City, TC 12345</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-4 sm:pt-6">
              <h4 className="font-semibold text-white text-base sm:text-lg mb-3 sm:mb-4">Follow Us</h4>
              <div className="flex space-x-3 sm:space-x-4">
                <a href="#" className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-500/20 border border-blue-500/30 rounded-xl flex items-center justify-center text-blue-400 hover:bg-blue-500/30 hover:border-blue-400/50 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-blue-500/20 touch-manipulation">
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 shadow-2xl shadow-blue-500/20">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {submitStatus === 'success' && (
                <div className="mt-6 p-6 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-400/30 rounded-2xl backdrop-blur-sm">
                  <div className="flex items-center justify-center space-x-3 mb-4">
                    ...
                    <div>
                      <h4 className="text-green-400 font-semibold text-lg">Message Sent Successfully!</h4>
                      <p className="text-green-300 text-sm">We've received your inquiry and will respond within 24 hours.</p>
                    </div>
                  </div>
              ...
              {submitStatus === 'error' && (
                <div className="mt-6 p-6 bg-gradient-to-r from-red-500/20 to-pink-500/20 border border-red-400/30 rounded-2xl backdrop-blur-sm">
                  <div className="flex items-center justify-center space-x-3">
                    ...
                    <div>
                      <h4 className="text-red-400 font-semibold text-lg">Submission Error</h4>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex items-center justify-center space-x-4 mb-4">
              ...
              />
              <span className="text-white font-bold text-xl">Innovative BIM Services</span>
            </div>
