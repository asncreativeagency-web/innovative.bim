  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Balanced Atmospheric Gradient for Centered Text - Adjusted for Visibility */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#0A0F1C]/60 via-transparent to-[#0A0F1C]/90" />
        <div className="absolute inset-0 bg-[#0A0F1C]/40 backdrop-blur-[3px]" />
      </motion.div>
      ...
      >
        <div className="max-w-5xl flex flex-col items-center">
          {/* Primary Headline - Innovative BIM Services */}
          <h1
            ref={headlineRef}
            className="text-[1.8rem] xs:text-[2.2rem] sm:text-5xl md:text-6xl lg:text-8xl font-extrabold text-white leading-tight tracking-tighter sm:tracking-tight mb-4 transform translate-y-12 opacity-0 transition-all duration-1000 ease-out drop-shadow-[0_10px_30px_rgba(0,0,0,0.9)] whitespace-nowrap"
            style={{ fontFamily: "'Inter', sans-serif", textShadow: '0 10px 50px rgba(0,0,0,0.9), 0 0 100px rgba(0,0,0,0.5)' }}
          >
            Innovative <span className="text-blue-400 drop-shadow-[0_0_20px_rgba(59,130,246,0.5)]">BIM Services</span>
          </h1>

          {/* Tagline - Positioned under the brand name */}
          <div
            ref={brandRef}
            className="mb-8 transform translate-y-12 opacity-0 transition-all duration-1000 delay-200"
          >
            <span className="text-blue-300 text-[10px] sm:text-xs md:text-sm font-bold uppercase tracking-[0.3em] sm:tracking-[0.5em] drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]">
              Construction-Ready BIM Modeling & Coordination
            </span>
          </div>
