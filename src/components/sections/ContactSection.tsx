...
const ContactSection: React.FC = () => {
  ...
  return (
    <div id="contact" className="relative bg-[#050810] overflow-hidden -mt-64 sm:mt-0 pt-0 sm:pt-16 pb-0">
                ...
                {submitStatus === 'success' && (
                  ...
                  >
                    <div>
                      ...
                      <h4 className="text-3xl font-bold text-white mb-3 uppercase tracking-tighter">
                        Thank You!
                      </h4>
                      <p className="text-blue-100 text-lg max-w-sm mx-auto leading-relaxed">
                        We've received your inquiry. Our technical team will review it and get back to you within 24-48 hours.
                      </p>
      ...
      {/* Corporate Footer */}
      <footer className="mt-0 sm:mt-16 bg-[#1e2633]">
        ...
        <div className="bg-[#1e2633] pt-0 -mt-32 sm:-mt-48 pb-8 sm:pb-10 text-center relative z-20">
          <div className="max-w-7xl mx-auto px-4">
            ...
            {/* Copyright */}
            <p className="text-gray-500 font-medium text-[9px] sm:text-[11px] tracking-[0.3em] sm:tracking-[0.5em] uppercase px-4" style={{ fontFamily: "'Outfit', sans-serif" }}>
              © 2026 Innovative BIM Services. All rights reserved. Built for global AEC and food service BIM delivery. Developed by <a href="https://www.fraylontech.com" target="_blank" className="text-blue-400/80 hover:text-blue-400 transition-colors" title="Fraylon Technologies - Expert Web and Software Development">Fraylon Technologies</a>.
            </p>
          </div>
        </div>
      </footer>
